...
import store.emall.backend.orderhub.client.media.FileDto;
import store.emall.backend.orderhub.client.media.MediaManagerClient;
import store.emall.backend.orderhub.client.media.MediaResponse;
