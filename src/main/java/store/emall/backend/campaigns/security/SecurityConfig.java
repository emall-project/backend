package store.emall.backend.campaigns.security;
...
import store.emall.backend.campaigns.security.filter.InternalAuthFilter;
import store.emall.backend.campaigns.security.filter.JwtValidationFilter;
import store.emall.backend.campaigns.security.handler.GlobalAccessDeniedHandler;
import store.emall.backend.campaigns.security.handler.GlobalAuthEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Public reads — genuinely public (frontend uses these)
